...
### Elige tu proveedor de IA (ya viene configurado para Ollama por defecto)

**Opción A — Ollama (100% local, recomendado si no quieres depender de nadie):**
1. Instala Ollama desde https://ollama.com
2. `ollama pull llama3.1`
3. Listo, tu `.env` ya apunta a `http://localhost:11434/v1` por defecto.

**Opción B — Groq (gratis en la nube, sin tarjeta, más rápido si tu PC es limitada):**
1. Crea tu key gratis en https://console.groq.com/keys
2. En `.env`, comenta las 3 líneas de la Opción A y descomenta las de Groq.

Ver `docs/DEPLOY_PROPIO.md` para dejar tu API accesible desde internet (con
un túnel gratis) manteniendo todo 100% bajo tu control.
